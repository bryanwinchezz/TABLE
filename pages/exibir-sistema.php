...
<body class="ficha-body <?= $classeBackground ?>">
                            ...
                            <div style="display: flex; gap: 15px; align-items: center;">
                                <?php if ($id_sistema != 1): ?>
                                    <button class="btn-pilula btn-compartilhar" onclick="gerarLinkCompartilhamento(this)"
                                        ...
                                        <i class="fas fa-share-alt"></i> <span class="texto-botao">COMPARTILHAR</span>
                                    </button>
                                <?php endif; ?>
                                <?php if ($isDono || (isset($_SESSION['usuario']['cargo']) && strtolower($_SESSION['usuario']['cargo']) === 'admin')): ?>
                                    <a href="editar-sistema.php?id=<?= $id_sistema ?>" style="text-decoration: none;">
                                        <button class="btn-pilula btn-editar-sistema"
                                            style="background: #b39ddb; color: #fff; padding: 10px 25px; font-size: 0.85rem; border: none; border-radius: 30px; font-weight: 800; cursor: pointer; transition: 0.3s;"><i
                                                class="fas fa-edit"></i> <span class="texto-botao">EDITAR SISTEMA</span></button>
                                    </a>
                                <?php endif; ?>
                                    ...
                                    <div class="card-ameaca-premium<?= $elClass ?>">
                                        ...
                                        <div class="card-ameaca-body">
                                            ...
                                            <div class="card-ameaca-details"
                                                ...
                                                <span
                                                    style="background: rgba(255, 50, 50, 0.15); color: #ff4d4d; padding: 1px 6px; border-radius: 4px; font-weight: 700;"><?= $isOrdemParanormal ? 'VD' : 'VT' ?>:
                                                    <b><?= $m['qt_vd'] ?? '???' ?></b></span>
    ...
    <script>
        ...
        function abrirModal(id) {
            ...
            if (el) {
                // Se for um dos modais de monstros, garante que ele está no body para evitar cortes de overflow
                if (id === 'modal-criar-monstro' || id === 'modal-ficha-monstro') {
                    ...
                    el.style.setProperty('background-color', 'rgba(0, 0, 0, 0.9)', 'important');
        ...
        function fecharModal(id) {
            ...
            if (el) {
                ...
                // Limpa propriedades inline adicionadas
        ...
        async function salvarMonstro() {
            ...
            let vida = document.getElementById('m-vida') ? document.getElementById('m-vida').value : 0;
            if (!window.isOrdemParanormal) {
                vida = vd;
            }
