...
<?php if (isset($_SESSION['alerta_boas_vindas'])): ?>
    <script>
        alert("<?= htmlspecialchars($_SESSION['alerta_boas_vindas']) ?>");
    </script>
    <?php unset($_SESSION['alerta_boas_vindas']); ?>
<?php endif; ?>
            ...
            <div class="nav-mobile-footer">
                <?php if (isset($_SESSION['usuario'])): ?>
                    <div class="usuario-logado-nav" onclick="window.location.href='perfil.php'">
                        <img src="<?= !empty($_SESSION['usuario']['foto']) ? $_SESSION['usuario']['foto'] : '../img/avatar1.png' ?>"
