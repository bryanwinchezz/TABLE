    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if (empty($login) || empty($senha)) {
            ...
            try {
                ...
                $stmt = $conn->prepare(
                    "SELECT id_usuario, nm_usuario, ds_email, ds_senha, tp_cargo, fl_ativo
                        FROM tb_usuario
            ...
            <form action="login.php" method="post" id="form-login" onsubmit="return true">
                <div class="grupo-formulario">
                    ...
                    <div class="grupo-input">
                        ...
                        <input type="text" id="nome" name="nome-email" required placeholder="Digite seu usuário ou e-mail" maxlength="50">
                    </div>
                </div>
                ...
                <div class="grupo-formulario">
                    ...
                    <div class="grupo-input senha-wrapper">
                        ...
                        <input type="password" id="senha-login" name="senha" required placeholder="Digite sua senha" maxlength="50">
