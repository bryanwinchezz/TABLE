        ...
        <div class="cartao-edicao">
            ...
            <div class="cabecalho-edicao">
                <div class="foto-container">
                    <img src="../img/foto-ficha.jpg" alt="Foto de perfil do usuário" class="foto-perfil">
                    <div class="icone-camera">
                        <i class="fas fa-camera"></i>
                    </div>
                </div>
                <div class="info-usuario">
                    <h2 id="exibicao-nome">Carregando...</h2>
                    <p id="exibicao-email">carregando@email.com</p>
                    <p class="membro-desde">Membro desde: 29/11/2025</p>
                </div>
            </div>
            ...
            <section>
                ...
                <form class="formulario-edicao" id="form-meus-dados">
                    ...
                    <div class="area-botao-centro">
                        <button type="button" id="btn-salvar-dados" class="botao-roxo">Salvar alterações</button>
                    </div>
                </form>
            </section>
